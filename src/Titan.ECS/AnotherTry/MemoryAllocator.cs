...
/// </summary>
public unsafe struct MemoryAllocator : IMemoryAllocator<MemoryAllocator>, IApi
{
    ...
    public static MemoryAllocator CreateAllocator2(Allocator allocator) 
        => new (allocator);

    internal void Reset(bool initialize = false) => _allocator.Reset(initialize);
}
