...
namespace Titan.Graphics.Shaders
{
    internal class ShaderLoader : IShaderLoader
    {
        ...
        {
            using var shader = _shaderCompiler.CompileShaderFromFile(_configuration.GetPath(descriptor.Filename), "main", "vs_5_0", descriptor.Defines ?? Array.Empty<ShaderDefines>());
        ...
        {
            var shader = _shaderCompiler.CompileShaderFromFile(_configuration.GetPath(descriptor.Filename), "main", "ps_5_0", descriptor.Defines ?? Array.Empty<ShaderDefines>());
