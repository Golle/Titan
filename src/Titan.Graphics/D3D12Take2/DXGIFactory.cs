...
internal unsafe struct DXGIFactory
{
    ...
    public bool Initialize(bool debug)
    {
        ...
        var hr = CreateDXGIFactory2(flags, typeof(IDXGIFactory7).GUID, (void**)_factory.GetAddressOf());
        if (FAILED(hr))
        {
    ...
    public static implicit operator IDXGIFactory7*(in DXGIFactory factory) => factory._factory;
