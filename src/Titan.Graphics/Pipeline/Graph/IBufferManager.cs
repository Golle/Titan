...
namespace Titan.Graphics.Pipeline.Graph
{
    public interface IBufferManager
    {
        ...
        DepthStencil GetDepthStencil(DXGI_FORMAT format = DXGI_FORMAT_R24G8_TYPELESS, D3D11_BIND_FLAG bindFlag = D3D11_BIND_DEPTH_STENCIL, DXGI_FORMAT shaderResourceFormat = DXGI_FORMAT_UNKNOWN);
    }
}
