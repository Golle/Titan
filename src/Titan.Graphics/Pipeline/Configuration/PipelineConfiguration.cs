...
namespace Titan.Graphics.Pipeline.Configuration
{
    ...
    public record RenderPassConfiguration(string Name, string Renderer, DepthStencilConfiguration DepthStencil, RenderTargetConfiguration[] RenderTargets, RenderPassResourceConfiguration[] Resources, RenderPassSamplerConfiguration[] Samplers);
