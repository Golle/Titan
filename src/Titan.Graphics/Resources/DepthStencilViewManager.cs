...
namespace Titan.Graphics.Resources
{
    internal unsafe class DepthStencilViewManager : IDepthStencilViewManager
    {
        ...
        public void Initialize(IGraphicsDevice graphicsDevice)
        {
            ...
            _device = graphicsDevice is D3D11GraphicsDevice device ? new ComPtr<ID3D11Device>(device.Ptr) : throw new ArgumentException($"Trying to initialize a D3D11 {nameof(DepthStencilViewManager)} with the wrong device.", nameof(graphicsDevice));
